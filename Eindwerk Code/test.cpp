...
void write_results_to_file(string file_name, valarray<double> results) {
...
tuple<int, double, double, double, double> handle_input(){
    ifstream input_file("1D_input.txt");
    string line;
    int N;
    double a;
    double r;
...
int main(){
    ...
    //node left up
    R_ver = calc_wire_resistance(circles[circles.size()-1], junctions[0], junctions[1], r, R);
    R_hor = calc_wire_resistance(circles[circles.size()-1], junctions[0], junctions[2], r, R);
    ...
    //node left down
    R_hor = calc_wire_resistance(circles[circles.size()-1], junctions[1], junctions[3], r, R);
